...
const AddVideogame = () => {
  ...
  const { name, description, price, categories, category, quantity, photo, loading, error, createdVideogame, redirectToProfile, formData } = values;
  ...
  const newVideogameForm = () => (
    <form className='mb-3' onSubmit={clickSubmit}>
      ...
      <button className='btn btn-outline-primary'>Create Videogame</button>
    </form>
  )
